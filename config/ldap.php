            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'account_suffix' => env('LDAP_ACCOUNT_SUFFIX', '@Eps.genco3.vn'),
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'eps.genco3.vn')),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'Administrator'),
                'password' => env('LDAP_PASSWORD', 'PwEp$20.18#07'),
