...
class ExtendDateConfirm extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject(Lang::getFromJson('Thông báo trả lời yêu cầu gia hạn xử lý.'))
        ...
        ->line(Lang::getFromJson('Yêu cầu gia hạn của bạn đã '. $this->data['gia_han'] == 2 ? "được đồng ý" : "bị từ chối"))
        ->line(Lang::getFromJson('Gia hạn tới: '))
