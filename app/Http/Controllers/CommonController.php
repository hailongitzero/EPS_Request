...
class CommonController extends Controller
{
    ...
    public function emailData($requestInfo)
    {
        ...
        $data = array(
            ...
            'phong_ban'     => $requestInfo->phong_ban['ten_phong_ban'] ?? null,
            'nguoi_xu_ly'   => $requestInfo->xu_ly['name'] ?? null,
            'nguoi_xu_ly_pb' => $phongBanXuLy['ten_phong_ban'] ?? null,
            ...
            'ngay_xu_ly'    => date("d/m/Y H:i:s", strtotime($requestInfo->ngay_xu_ly)) ?? null,
            'gia_han'       => $requestInfo->gia_han,
            'ngay_gia_han'  => date('d/m/Y H:i:s', strtotime($requestInfo->ngay_gia_han)) ?? null,
