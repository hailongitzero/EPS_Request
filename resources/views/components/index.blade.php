                ...
                <ul class="things-to-do">
                    <li>
                        <p>
                            ...
                            <a class="btn btn-success" href="flaty.html#">Go</a>
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <div class="messages-actions">
                                <a class="show-tooltip" href="flaty.html#" title="Approve"><i class="fa fa-check green"></i></a>
                                <a class="show-tooltip" href="flaty.html#" title="Disapprove"><i class="fa fa-times orange"></i></a>
                                <a class="show-tooltip" href="flaty.html#" title="Remove"><i class="fa fa-trash-o red"></i></a>
                            </div>
                        </div>
                    </li>
                    <li>
        ...
        <div class="box box-pink">
            ...
            <div class="box-content">
                ...
                <div class="messages-input-form">
                    <form method="POST" action="flaty.html#">
                        <div class="input">
                            <input type="text" name="text" placeholder="Write here..." class="form-control">
                        </div>
                        <div class="buttons">
                            <a class="show-tooltip" href="flaty.html#" title="Take Picture"><i class="fa fa-camera"></i></a>
                            <a class="show-tooltip" href="flaty.html#" title="Attach File"><i class="fa fa-paperclip"></i></a>
        ...
        <div class="box box-green">
            ...
            <div class="box-content">
                <ul class="todo-list">
                    <li>
                        <div class="todo-desc">
                            <p><a href="flaty.html#">Fix some bugs</a></p>
                        </div>
                        <div class="todo-actions">
                            <span class="label label-important">Today</span>
                            <a class="show-tooltip" href="flaty.html#" title="It's done"><i class="fa fa-check"></i></a>
                            <a class="show-tooltip" href="flaty.html#" title="Remove"><i class="fa fa-times"></i></a>
                        </div>
                    </li>
                    <li>
                        <div class="todo-desc">
                    ...
                    <li>
                        <div class="todo-desc">
                            <p><a href="flaty.html#">Remove some posts</a></p>
                        </div>
                        <div class="todo-actions">
                    ...
                    <li>
                        <div class="todo-desc">
                            <p><a href="flaty.html#">Hire developers</a></p>
                        </div>
                        <div class="todo-actions">
                    ...
                    <li>
                        <div class="todo-desc">
                            <p><a href="flaty.html#">New frontend design</a></p>
                        </div>
                        <div class="todo-actions">
                            <span class="label label-info">Next week</span>
                            <a class="show-tooltip" href="flaty.html#" title="It's done"><i class="fa fa-check"></i></a>
